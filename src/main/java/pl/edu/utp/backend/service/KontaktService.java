    ...
    public  void  populateTestData(){
        ...
        if(kontaktRepository.count() == 0){
            ...
            kontaktRepository.saveAll(
                    Stream.of("Jan Kowalski","Zbigniew Nowak","Ewa Mazur","Marzena Czarnecka","Alisa Baran","Joanna Brzezińska","Edyta Krajewska", "Jowita Zalewska","Marcela Sobczak","Adnrea Pitrowska",
                            "Cecylia Rutkowska","Amelia Mróz","Izabela Zakrzewska","Wanda Sokołowska","Berenika Laskowska","Arleta Szulc","Liliana Marciniak","Justyna Jasińska","Adrianna Czerwińska",
                            "Jowita Kwiatkowska","Helena Wróblewska","Andżelika Sobczak","Przemysław Nowak","Kuba Włodarczyk","Błażej sikorski","Jarosław Mazurek","Jakub Włodarczyk","Marcel Szczepański")
                            .map(dane ->{
                                ...
                                String email = (kontakt.getImie()+ "."+ kontakt.getNazwisko()+ "@"+ kontakt.getFirma().getNazwa()
